...
TARGET=ga_overlap ga_reads_summit ga_reads_summit_all ga_calc_dist
#CFLAGS+=-O3
CFLAGS+=-O0
CFLAGS+=-g
CFLAGS+=-Wall
...
all: ga_overlap ga_reads_summit ga_reads_summit_all ga_calc_dist
...
clean:
	rm -f $(OBJS1) $(OBJS2) $(OBJS3) $(OBJS4) $(TARGET)

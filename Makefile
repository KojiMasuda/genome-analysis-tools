...
TARGET=ga_overlap ga_reads_summit ga_reads_summit_all ga_calc_dist ga_reads_region ga_deltaG
#CFLAGS+=-O3
CFLAGS+=-O0
CFLAGS+=-g
CFLAGS+=-Wall
...
all: ga_overlap ga_reads_summit ga_reads_summit_all ga_calc_dist ga_reads_region ga_deltaG
...
clean:
	rm -f $(OBJS1) $(OBJS2) $(OBJS3) $(OBJS4) $(OBJS5) $(OBJS6) $(TARGET)
